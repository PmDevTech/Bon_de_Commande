...
Public Class ListeRestreindreAMI
    ...
    Private Sub ChargerListeDossier()
        ...
        Try
            query = "select NumeroDAMI from t_ami where EvalTechnique IS NOT NULL order by NumeroDAMI ASC"
    ...
    Public Sub ChargerListeRestreindre(ByVal NumDossier As String)
        ...
        dtt.Columns.Add("Nom et prénom consultant", Type.GetType("System.String"))
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                For Each rw As DataRow In dt.Rows
                    ...
                    drS("Nom et prénom consultant") = MettreApost(rw("NomConsult").ToString)
