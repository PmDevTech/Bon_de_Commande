...
Public Class EvalValidationMoyenneAMI
    ...
    Private Sub EvalValidationMoyenneAMI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)  Handles MyBase.Load
    ...
    Private Sub ChargerListe()
        ...
        query = "select CodeMem,NomMem,PasseMem,TitreMem from T_Commission where NumeroDAO='" & EvaluationTDR.CmbNumDoss.Text & "' and TypeComm='EVAC'"
    ...
    Private Sub BtValider_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtValider.Click
        ...
        query = "select * from T_AMI where NumeroDAMI='" & EvaluationTDR.CmbNumDoss.Text & "' and CodeProjet='" & ProjetEnCours & "'"
        ...
        DatSet.Tables!T_AMI.Rows(0)!EvalTechnique = Now.ToShortDateString & " " & Now.ToLongTimeString
