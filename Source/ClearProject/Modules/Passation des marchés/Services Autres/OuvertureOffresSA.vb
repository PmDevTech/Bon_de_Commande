...
Public Class OuvertureOffresSA
    ...
    Private Sub BtOuvertureOffre_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtOuvertureOffre.Click
        ...
        ElseIf (Deb = "Fin" Or Deb = "Eta") Then
            ...
            If (Deb <> "Eta") Then
                ...
                query = "Update T_DAO set DateFinOuverture='" & dateconvert(Now.ToShortDateString) & " " & Now.ToLongTimeString & "', DureeSeance='" & BtDureeSeance.Text.Replace(" ", "") & "', DateModif='" & dateconvert(Now.ToShortDateString) & " " & Now.ToLongTimeString & "', Operateur='" & CodeOperateurEnCours & "' where NumeroDAO='" & CmbNumDAO.Text & "' and CodeProjet='" & ProjetEnCours & "'"
                ExecuteNonQuery(query)
            ...
            reportPVO.SetParameterValue("NumDao", CmbNumDAO.Text)
    ...
    Private Sub BtEnrgOffre_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtEnrgOffre.Click
        ...
        If btnAjoutSousLot.Enabled = True Then
            ...
            If ViewMontantDesSL.RowCount <> nbsouslot Then
                erreur += "- le montant des sous lot" + ControlChars.CrLf
            End If
        End If
    ...
    Private Sub ModifierLoffreToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ModifierLoffreToolStripMenuItem.Click
        If ListeRecap.Nodes.Count > 0 Then
            btnAjoutSousLot.Text = "Modifier montant des sous lot"
    ...
    End Sub
    Private Sub GridRecapOffre_MouseUp(sender As Object, e As MouseEventArgs)
        'If OuvertureTermine +
    End Sub
